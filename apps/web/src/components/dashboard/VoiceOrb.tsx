...
export function VoiceOrb({ isSpeaking, isListening, isUserSpeaking, userAudioLevel }: { isSpeaking: boolean; isListening: boolean; isUserSpeaking: boolean; userAudioLevel: number }) {
  ...
  return (
    <div className={`voice-orb ${stateClass} w-[280px] h-[280px] md:w-[400px] md:h-[400px] lg:w-[480px] lg:h-[480px] rounded-full relative flex items-center justify-center transition-transform duration-700 hover:scale-[1.03]`}>
